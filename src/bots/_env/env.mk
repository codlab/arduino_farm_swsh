...
SRC_CORE     = $(ROOT_FOLDER)/core/serial_report.c $(ROOT_FOLDER)/core/millis.c $(ROOT_FOLDER)/core/action.c $(ROOT_FOLDER)/core/default_sequences.c $(ROOT_FOLDER)/core/usb_device.c $(ROOT_FOLDER)/core/calendar_skip.c
