...
#ifndef DAY_SKIPPER_EU_NOLIMIT_INCLUDED
#define DAY_SKIPPER_EU_NOLIMIT_INCLUDED
...
// -> You MUST set your current date to Janurary 31st of any month with 31 days, year doesn't matter
// -> It takes ~43 seconds per 30 days

// -> Set number of days you want to skip,can't be greater than 4294967295
unsigned long eu_no_limit = 200000;
/*------------------------------------------*/
