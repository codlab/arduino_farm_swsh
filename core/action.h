...
#define STEP_UP_A(TIME, WAIT_FOR) {UP_A, TIME}, {NOTHING, WAIT_FOR}
#define STEP_DOUBLE_LEFT(TIME, WAIT_FOR) {DOUBLE_LEFT, TIME}, {NOTHING, WAIT_FOR}
#define STEP_DOUBLE_RIGHT(TIME, WAIT_FOR) {DOUBLE_RIGHT, TIME}, {NOTHING, WAIT_FOR}
#define STEP_HOME(TIME, WAIT_FOR) {HOME, TIME}, {NOTHING, WAIT_FOR}
#define STEP_PLUS(TIME, WAIT_FOR) {PLUS, TIME}, {NOTHING, WAIT_FOR}
#define STEP_MINUS(TIME, WAIT_FOR) {MINUS, TIME}, {NOTHING, WAIT_FOR}
...
#define STEP_CIRCLE(TIME, WAIT_FOR) {CIRCLE, TIME}, {NOTHING, WAIT_FOR}
#define STEP_LCLICK(TIME, WAIT_FOR) {LCLICK, TIME}, {NOTHING, WAIT_FOR}
#define STEP_RCLICK(TIME, WAIT_FOR) {RCLICK, TIME}, {NOTHING, WAIT_FOR}

#define STEP(ACTION, TIME) {ACTION, TIME}
#define STEP_WAIT(ACTION, TIME, NOTHING_TIME) {ACTION, TIME}, { NOTHING, WAIT_FOR}
